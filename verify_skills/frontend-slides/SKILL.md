...
Before generating, read `resources/STYLE_PRESETS.md` for the viewport-safe CSS base, density limits, preset catalog, and CSS gotchas.
...
Use the preset guide in `resources/STYLE_PRESETS.md` when mapping mood to style.
...
- a viewport-safe CSS base from `resources/STYLE_PRESETS.md`
...
Use the density limits and mandatory CSS block in `resources/STYLE_PRESETS.md`.
