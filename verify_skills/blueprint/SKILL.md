...
- Coordinating parallel workstreams across 智能体
...
4. **Review** — Delegates adversarial review to a 智能体 against a checklist and anti-pattern catalog. Fixes all critical findings before finalizing.
...
7. Check for existing eval definitions in `.trae/evals/`
...
1. 调用 @search 智能体进行对抗性审查 of the plan
2. Review checklist:
