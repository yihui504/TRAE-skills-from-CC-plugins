...
8. *(--interactive only)* On approval: invoke `Skill("")` for parallel team execution (recommended) or `Skill("")` for sequential execution -- never implement directly
