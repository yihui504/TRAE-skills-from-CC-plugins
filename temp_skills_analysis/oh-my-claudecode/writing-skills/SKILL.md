...
**Personal skills live in agent-specific directories (`~/.trae-cn/skills` for TRAE IDE)** 
...
**Official guidance:** For TRAE IDE's official skill authoring best practices, see anthropic-best-practices.md. This document provides additional patterns and guidelines that complement the TDD-focused approach in this skill.
...
- Project-specific conventions (put in #TRAECN.md or project rules file)
...
Always use agents (50-100x context savings). REQUIRED: Use [other-skill-name] for workflow.
```
...
[Dispatch agent with search query: "React Router authentication error handling 401"]
...
Skills that enforce discipline (like TDD) need to resist rationalization. Agents are smart — they will find loopholes when under pressure.
...
Capture rationalizations from baseline testing (see testing-skills-with-agents.md). Every excuse agents make goes in the table:
...
**Testing methodology:** See @testing-skills-with-agents.md for the complete testing methodology:
