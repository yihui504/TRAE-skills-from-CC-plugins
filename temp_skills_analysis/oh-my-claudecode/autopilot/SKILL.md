...
- **否则**：调用 @backend-architect 智能体提取需求并创建技术规格
...
- 调用 @backend-architect 智能体创建计划
- 调用 @backend-architect 智能体验证计划
...
- 调用 @backend-architect 智能体：功能完整性
- 调用 @backend-architect 智能体（带安全审查指令）：漏洞检查
- 调用 @backend-architect 智能体（带质量审查指令）：质量审查
