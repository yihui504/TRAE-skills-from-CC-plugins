...
```
调用 @search 智能体, query="[RESEARCH_STAGE:1] 调查认证实现模式..."

调用 @backend-architect 智能体, query="[RESEARCH_STAGE:2] 分析API层的错误处理..."

调用 @backend-architect 智能体, query="[RESEARCH_STAGE:3] 深度分析缓存策略..."
```
...
```
调用 @backend-architect 智能体, query="
