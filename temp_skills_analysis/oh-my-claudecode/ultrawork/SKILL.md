...
```
调用 @backend-architect 智能体，任务描述: "Add missing type export for Config interface"
调用 @frontend-architect 智能体，任务描述: "Implement the /api/users endpoint with validation"
调用 @search 智能体，任务描述: "Find all test files related to auth middleware"
```
